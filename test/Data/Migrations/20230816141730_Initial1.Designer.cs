...
namespace test.Data.Migrations
{
    ...
    [Migration("20230816141730_Initial1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("test.Models.Color", b =>
                {
            ...
            modelBuilder.Entity("test.Models.Size", b =>
                {
                    b.Property<int>("SizeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("test.Models.Product", b =>
                {
                    ...
                    b.HasOne("test.Models.Color", "Color")
                        .WithMany()
                        .HasForeignKey("ColorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("test.Models.Size", "Size")
                        .WithMany()
